				                                ...
				                                <li>
				                                  ...
				                                  <li>
				                                   ...
				                                   <strong>DOB:</strong><?php echo $player["player_dob"];?>
				                                 	...
				                                 	<?php if ($this->team[0]['team_type'] != 'national') { ?>
					                                 <li class="MoreStats">
					                                   <strong>Games Played:</strong><?php echo $player["player_appearences"];?><br/>
					                                   <strong>Goals Scored:</strong><?php echo $player["player_goals"];?><br/>
					                                   <strong>Yellow Cards:</strong><?php echo $player["player_yellowcards"];?><br/>
					                                   <strong>Red Cards:</strong><?php echo $player["player_redcards"];?><br/>
					                                 </li>
				                                 	<?php } ?>
	    					     	 ...
	    					     	 <div id="gridDisplayFriends" class="closeDiv">
                            			<?php  
	                                      ...
	                                      foreach ($this->paginator as $data) {
	                                        $player_name_seo = $urlGen->getPlayerMasterProfileUrl($data["player_nickname"], $data["player_firstname"], $data["player_lastname"], $data["player_id"], true , $player["player_common_name"]);
	                                        $userCounter++;
	                                        if($userCounter==1){
	                                            ?>
	                                        ...
	                                        <?php } ?>
                                                	...
                                                	<?php
                                                      ...
                                                      <br/>
                                                      <a  href="<?php echo $urlGen->getShowDomesticCompetitionsByCountryUrl($data["country_name"], $data["player_country"], True); ?>" title="<?php echo $data["country_name"];?>">
