...
<div id="FormWrapper" style="width:795px;background:none;">
                ...
                <div id="FormWrapperForBottomBackground">
                    ...
                    <form id="join" name="register_form" method="POST" action="">
                    	<div id="FieldsetWrapper">
							...
							<h5>Already a member?  <a href="<?php echo Zend_Registry::get("contextPath"); ?>/login" title="Sign In">Click here to log in</a>
		...
		jQuery.ajax({
			...
			success: function(text){
					if(text!= ''){
						...
						top.location.href = 'http://www.vgmediagroup.com/test/html/goalfaceorg/registrationconfirmation.php';
           		    }
			}
