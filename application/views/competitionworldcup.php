...
function addGoalShout(){
 ...
 function populateCombo(dtarget , id, seasonId){
	 var url = null;
	 var ajaxload = null;
	 url = '<?php echo Zend_Registry::get("contextPath"); ?>/player/findplayersbyteam/id/'+id+'/season/'+seasonId;
        ...
        <div class="img-shadow">
	       <div class="WrapperForDropShadow" style="border:none;">
	         <a href="<?php echo Zend_Registry::get("contextPath"); ?>/subscribe" title="Subscriptions and Alers">                          
                 <img border="0" src="<?php echo Zend_Registry::get("contextPath"); ?>/public/images/Banner_world_cup.png" style="margin-bottom:-3px;"/>
          	</a>
        	</div>
        </div>
           ...
           <?php if($teamCounter==3){ $teamCounter = 0; ?>
            ...
            <?php } ?>
              ...
              <?php } 
                ...
                <p class="smatch1">
                    <a class="OrangeLink" href="<?php echo Zend_Registry::get("contextPath"); ?>/teams/world/2014-brazil/world-cup_10561027">See More Featured Teams</a>
                </p>
            </div>
           ...
           <?php if($playerCounter==3){ $playerCounter = 0; ?>
            ...
            <?php } ?>
              ...
              <?php }
                ...
                <p class="smatch1">
                    <a class="OrangeLink" href="<?php echo Zend_Registry::get("contextPath"); ?>/competitions/showcompetitionplayers/leagueid/72/">See More Featured Players</a>
                </p>
            </div>
			...
			<div id="menu16content" style="display: none;">
           	...
           	<div class="featured1">
                    ...
                    <div class="cont" id="menu1content">
                            <p class="twoteams">Compare two teams' recent form and past World Cup <br/>tournament performances.</p>
                    ...
                    <div class="cont" id="menu2content">
						          <p class="twoteams">Compare two players' recent form and past World Cup <br/>tournament performances.</p>
