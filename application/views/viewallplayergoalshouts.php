	...
	function rateActivity(activityId, rateValue)
	{
	 ...
	 function reportAbuse(id , reportTo ){
			...
			jQuery('#acceptReportAbuseButtonId').click(function() {
				...
				jQuery.ajax({
					type: 'POST',
					data:({playerid :playerid , id : id ,reportTo : reportTo , dataReport : dataReport ,reportType:reportType}),
					url: '<?php echo Zend_Registry::get("contextPath"); ?>/player/reportabuse',
					success: function(data){
    ...
    <div id="ContentWrapper" class="TwoColumnLayout">
          ...
          <?php echo $this->render('include/navigationPlayerNew.php');?>
            ...
            <div class="SecondColumn" id="SecondColumnPlayerProfile">
                <h1><?php echo	$this->playername;?> Gooal Shouts</h1>
          					<div class="img-shadow">
          						<div class="WrapperForDropShadow">
					                      ...
					                      <a name="boxcomments"></a> 
					                        <form id="comment_form" style="padding-bottom:30px;" method="post" name="comment_form" action="<?php echo Zend_Registry::get("contextPath"); ?>/profile/addgoalShout">
					                           <textarea <?php if($session->email == null){ ?> 
					                            ...
					                            <input type="hidden" name="commentType" id="commentTypeId"	value="3">
						                        <input type="hidden" name="idtocomment" id="idtocommentId"	value="<?php echo $this->playerid; 	?>">
						                        <input type="hidden" name="screennametocomment"  id="screennametocommentId"	value="<?php echo $session->screenName; ?>">
						                        <input type="hidden" name="playerId" id="playerId" value="<?php echo $this->playerid; 	?>">	
                                ...
                                ?>     
                                    ...
                                    <dl class="comment<?php echo($this->totalPlayerComments == 1? ' commentNoBorder' : '')?>">
                                      <dt class="shout">
                                      ...
                                      <dd>
                                        ...
                                        <?php 
                                        if($session->screenName == $uc['screen_name'])
                                        {
									             ...
									             <div id="comment_reply_wrapper_<?php echo $i;?>" class="nestedwrapper">
									                ...
									                <div class="rightcomment_nested">
								                       <span class="author">
														...
														<?php echo $common->convertDates($reply["activity_date"]);?>
														<?php 
                                ...
                                } //Close enclosing if loop
                                else 
                                { 
                                ?>  
                                    No Goooal Shouts for this player							 
          			          	<?php 
                                }  
                               ?>  
