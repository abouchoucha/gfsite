...
?>
  ...
  <div class="scores">
             ...
             <div class="scores1">
                   <ul>
                   	<li class="silueta"><img alt="" src="<?php echo Zend_Registry::get("contextPath"); ?>/public/images/siloute_18x18.jpg"></li>
                       <li class="name">
                       		<a href="/players/ronaldo_159/">Ronaldo</a>
                       </li>
                       <li class="position">Forward</li>
                       <li class="team" style="background: url('/public/images/flags/35.png') no-repeat scroll left center transparent;">
                            <a href="/teams/brazil_349/">Brazil</a>
                       </li>
