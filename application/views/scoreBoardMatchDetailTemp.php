    ...
    <div class="flags">
     ...
     <div class="SecondColumn">
        <div class="img-shadow">
                ...
                <div id="MatchDetailsTop">
                    ...
                    <div>
                        ...
                        <span id="feature_matchDate_page">	
                        	<?php echo date ('F j , Y' , strtotime($this->match[0]["match_date"]));?>
                        </span>
                    </div>
                    <div>
                    ...
                    <?php if($this->competitionType != 'international') { ?>
                        <div>
			...
			<span> 
                            <h3><a href="<?php echo $urlGen->getClubMasterProfileUrl($this->match[0]["team_a"], $this->match[0]["t1seoname"], True); ?>"><?php echo $this->match[0]["t1"];?></a></h3>
                        </span>
                        ...
                        <?php if($this->goalsteamA != null ) { ?>
                                      <?php foreach($this->goalsteamA as $goal) {
                                        ...
                                        ?>
                                            <span><img border="0" src="<?php echo Zend_Registry::get("contextPath"); ?>/public/images/small_soccerball.gif" alt="Goal" /> <?php /*?><a href="<?php echo $player_name_seo;?>"><?php echo $goal["player_name_short"];?></a>*/?> <?php echo $goal["player_name_short"];?> <?php echo $goal["event_minute"];?>'&nbsp;   <?php if($goal["event_type_id"] != 'G' ) { ?>
            ...
            <?php if($this->lineUp != null){?>
                ...
                <div id="MatchDetailsPlayers">
                    ...
                    <!--<div class="Header">Line Ups</div>Team A-->
                    <!--<div class="Header TeamB">Lineups</div>Team B-->

                    <div class="StatWrapper">
                    <?php if($this->lineUp != null ) { ?>
                        <!--Lineups Team A-->
                        <div>
                          <?php foreach($this->lineUp as $lineUp) {
                            ...
                            ?>
                                  <?php /* <a href="<?php echo $player_name_seo;?>"><?php echo $lineUp["player_name_short"];?></a><br /> */?>
                                  <span><?php echo $lineUp["jersey_number"]; ?></span>
                                  <?php echo $lineUp["player_name_short"];?><br />
                            <?php
                                    }
                                } ?>
                         </div>
                ...
                <div id="MatchDetailsPlayers">
                    ...
                    <div class="StatWrapper" style="padding-top:20px;height:140px;">
                    ...
                    <!--List players subs and minute team A-->
                          ...
                          ?>
                                ...
                                <?php /* <a href="<?php echo $player_name_seo_out;?>"><?php echo $this->subsOut[$cont]["player_name_short"];?></a>*/?>
                                ...
                                <?php /* <a href="<?php echo $player_name_seo;?>"><?php echo $subsIn["player_name_short"];?></a>*/?>
                ...
                <div id="MatchDetailsPlayers">
                    ...
                    <!--List players subs and minute team A-->
                          ...
                          ?>
                                <?php /* <a href="<?php echo $player_name_seo;?>"><?php echo $card["player_name_short"];?></a>*/ ?><?php echo $card["player_name_short"];?>&nbsp;<?php echo $card["event_minute"];?>'
                          <?php
                               echo "<BR>";
                                 } else { echo "&nbsp;";}
                              $cont++;
				...
				<!-- Current Form -->
                          ...
                          <div class="DropShadowHeader BrownGradientForDropShadowHeader">
							...
							<div id="leaguetables">
								 <table id="headtohead" width="355px" cellspacing="0" cellpadding="1" border="0">
                                    <tbody> 
                                    	<tr class="oddmatch">
                    ...
                    <div id="scoreboard" class="img-shadow">
	                    <div class="WrapperForDropShadow">
	                        <div class="DropShadowHeader BlueGradientForDropShadowHeader">
	                             ...
	                             <span>
	                                 <a href="<?php echo $urlGen->getTablesUrl("scores",$this->roundId ,$this->countryName ,$this->seasonTitle ,  $this->competitionName ,True) ?>" title="Football Score Board">See More &raquo;</a>
	                            </span>
	                        </div>
