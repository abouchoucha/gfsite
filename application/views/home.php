...
<script type="text/JavaScript">
 ...
 jQuery(document).ready(function() {
  ...
  //setup tabs - featured players and teams
	 jQuery('#menu6content').hide();
	 jQuery('#menu7content').hide();
	      jQuery('#menu6content').show();
        jQuery('#menu6').addClass('active');
        jQuery('div.nxt ul li').click(function(){
           // var thisClass = this.className;
            jQuery('div.nmatch').hide();
...
<!--Feedback--> <!--Goalface Join Now-->
<div class="img-shadow">
<div class="WrapperForDropShadow"><a
	href="<?php echo Zend_Registry::get("contextPath"); ?>/user/register"
	title="GoalFace Registration"> <img border="0"
	src="<?php echo Zend_Registry::get("contextPath"); ?>/public/images/join_now_green.jpg"
...
<div class="SecondColumn"><!--New  Featured  Teams and Players -->

<div class="prof">
<p class="mblack"><span class="black">Featured Teams &amp; Players</span>
<span id="menu6_more" class="sm"> <a
	href="<?php echo $urlGen->getFeaturedTeamsUrl(TRUE);?>">More &raquo;</a>
</span> <span id="menu7_more" class="sm" style="display: none;"> <a
	href="<?php echo $urlGen->getFeaturedPlayersUrl(TRUE);?>">More &raquo;</a>
</span></p>
<div class="nxt">
<ul>
	<li id="menu6" onclick="return showTab('6')"><a href="#">Teams</a></li>
	<li id="menu7" onclick="return showTab('7')"><a href="#">Players</a></li>
</ul>
</div>
<div class="nmatch" id="menu6content">
                        ...
                        <?php }  ?>
                         ...
                         <?php } ?>
                              ...
                              <p class="smatch1"><a class="OrangeLink"
	href="<?php echo $urlGen->getFeaturedTeamsUrl(TRUE);?>">See More
Featured Teams</a></p>
</div>

<div class="nmatch" id="menu7content" style="display: none;">
                        <?php
                            $playerCounter = 0;
                        ...
                        <?php }  ?>
                           ...
                           <p
	class="<?php if($playerCounter==2){ echo "tfa1"; } else { echo "tfa"; } ?>">

<a
	href="<?php echo $urlGen->getPlayerMasterProfileUrl($pp["player_nickname"], $pp["player_firstname"], $pp["player_lastname"], $pp["player_id"], true ,$pp["player_common_name"]); ?>"
	title="<?php echo $pp["player_name_short"] ?>">
                                    <?php
                                    	$path_player_photos = $config->path->images->players . $pp["player_id"] .".jpg" ;
						                if (file_exists($path_player_photos)) {
                                    ?>
                                        <img
	src="<?php echo Zend_Registry::get("contextPath"); ?>/utility/imagecrop?w=80&h=80&zc=1&src=<?php echo Zend_Registry::get("contextPath"); ?><?php echo $this->root_crop;?>/players/<?php echo $pp["player_id"]; ?>.jpg"
	alt="<?php echo $pp["player_common_name"];?>" />
                                   <?php } else  { ?>
                                        <img
	src="<?php echo Zend_Registry::get("contextPath"); ?>/public/images/Player1Text80.gif"
	alt="<?php echo $pp["player_common_name"];?>" />
                                  <?php } ?>
                                </a> <a
	href="<?php echo $urlGen->getPlayerMasterProfileUrl($pp["player_nickname"], $pp["player_firstname"], $pp["player_lastname"], $pp["player_id"], true ,$pp["player_common_name"]); ?>"
	title="<?php echo $pp["player_name_short"] ?>">
                          ...
                          <?php } ?>
                              ...
                              <p class="smatch1"><a class="OrangeLink"
	href="<?php echo $urlGen->getFeaturedPlayersUrl(TRUE);?>">See More
Featured Players</a></p>
</div>
</div>
...
<span> <a
	href="<?php echo Zend_Registry::get("contextPath"); ?>/community/showallactivititiesdetail"
	title="see more">More &raquo;</a> </span></div>

<div class="BlueShaded DisplayDropdown">
<div class="secondaryDropDown">Show: <select id="activityId"
	class="slct" name="activityId">
	<option value="all" selected="selected">All Activity</option>
	<option value="1">Friends</option>
	<option value="2">Teams</option>
	<option value="3">Players</option>
	<option value="4">Leagues & Tournaments</option>
	<option value="5">News</option>
</select> <input style="display: inline;" type="submit"
	id="buttonActivity" value="Ok" class="submit"></div>
<div class="JoinedDate"><a
	href="<?php echo Zend_Registry::get("contextPath"); ?>/community/showrssfeed"
	class="OrangeLink">Subscribe</a></div>
</div>
...
<div id="SeeMoreNews" class="SeeMoreNews"><a class="OrangeLink"
	href="<?php echo Zend_Registry::get("contextPath"); ?>/community/showallactivititiesdetail"
	title="See More Activities">See more pulse updates</a></div>
</div>
</div>


<div class="prof">
<p class="mblack"><span class="black">Fan Profiles</span> <span
	class="sm" id="menu6_more">
                            	<?php if($session->email == null){ ?>
                  				 <a href="javascript:loginModal();"
	title="GoalFace Fan Profiles">More »</a>
                  			<?php }else{?>	 
                            	<a
	href="<?php echo $urlGen->getMainProfilesPage(true); ?>"
	title="GoalFace Fan Profiles">More »</a>
                            <?php }?>	
                           </span></p>
<form id="profilesHomeForm" style="display: inline;"
	name="profilesHomeForm" action="#" method="get">
<p class="show"><label>Show:</label> <select id="profilesSelect"
	name="search" class="most">
	<option value="popular#mp">Most Popular</option>
                                        <?php if($session->email != null) {?>
                                        <option value="likeme#lm">Like
	Me</option>
                                        <?php } ?>
                                        <option value="active#ma">Most
	Active</option>
	<option value="recently#ru">Recently Updated</option>
	<option value="newest#nw">Newest</option>
	<option value="online#onl">Online</option>
</select> <input style="display: inline;" type="submit"
	id="buttonProfile" value="Ok" class="submit"></p>
</form>

<div id="randomprofiles" class="nmatch"></div>

<p class="modfooter">
                        	<?php if($session->email == null){ ?>
                        	<a class="orangelink"
	href="javascript:loginModal();">Browse</a> | <a class="orangelink"
	href="javascript:loginModal();">Most Popular</a>
                        	<?php }else{?>	
                        	<a class="orangelink"
	href="<?php echo $urlGen->getMainProfilesPage(true); ?>">Browse</a> | <a
	class="orangelink"
	href="<?php echo Zend_Registry::get("contextPath"); ?>/profiles">Most
Popular</a>
                        	<?php }?>
                        </p>
...
<div class="BlueShaded DisplayDropdown">Show: <select id="headLineId"
	class="slct" name="headLineId">
	<option value="5" selected="selected">5 Headlines</option>
	<option value="10">10 Headlines</option>
	<option value="15">15 Headlines</option>
</select> <input style="display: inline;" type="submit" id="buttonNews"
	value="Ok" class="submit"></div>

<div id="FeaturedNewsList">
<div id="topnewsWorking">Updating...</div>
</div>
...
<!-- Competition Gallery --> <!-- 			        <div class="featured1">
					 	<p class="mblack">
...
<span> <a
	href="<?php echo $urlGen->getMainScoresAndMatchesPageUrl(true); ?>"
	title="Football Score Board">More &raquo;</a> </span></div>
<div class="WrapperForScoreTab" id="scoretabBodyId">
<ul id="main_tabs" class="TabbedHomeNav">
                            <?php if ($session->email != null) { ?>
                                <li id="myScoresTabLi"
		style="font-size: 12px;"><a id="myScoresTab" href="javascript:void(0)">My
	Scoreboard</a></li>
                            <?php }?>
                                <li id="scoresTabLi" class="Selected"
		style="font-size: 12px;"><a id="scoresTab" class="Selected"
		href="javascript:void(0)">Scores</a></li>

	<li id="schedulesTabLi" style="font-size: 12px;"><a id="schedulesTab"
		href="javascript:void(0)">Schedules</a></li>
</ul>
<br class="ClearBoth" />
<div id="ScoresSchedulesWrapperBox">
<div id="tab_1" class="tabContent" style="display: none">

<div class="FeaturedNewsSort" id="MyScoresDateFilter"><a
	href="javascript:void(0);" id="todayms" class="filterSelected">Today</a>
| <a href="javascript:void(0);" id="l3ms">Last 3 Days</a> | <a
	href="javascript:void(0);" id="l7ms">Last 7 Days</a> |</div>

<div id="ScorecardContainer">

<div id="scoreboardResult0">Loading..</div>
</div>
</div>
<div id="tab_2" class="tabContent" style="">

<div class="FeaturedNewsSort" id="ScoresDateFilter"><a
	href="javascript:void(0);" id="today" class="filterSelected">Today</a>
| <a href="javascript:void(0);" id="l3">Last 3 Days</a> | <a
	href="javascript:void(0);" id="l7">Last 7 Days</a> |</div>

<div id="ScorecardContainer">
<div id="scoreboardResult">Loading...</div>
</div>
</div>
<div id="tab_3" class="tabContent" style="display: none;">
<div class="FeaturedNewsSort" id="SchedulesDateFilter"><a
	href="javascript:void(0);" id="tomorrow" class="filterSelected">Tomorrow</a>
| <a href="javascript:void(0);" id="n3">Next 3 Days</a> | <a
	href="javascript:void(0);" id="n7">Next 7 Days</a> |</div>
<div id="ScorecardContainer">
<div id="scoreboardResult2">Loading..</div>
</div>
</div>
</div>
</div>
<div class="SeeMoreNews"><a class="OrangeLink"
	href="<?php echo $urlGen->getMainScoresAndMatchesPageUrl(true); ?>"
	title="Live football scores from around the world">See all scores from
around the world</a></div>
...
<div class="WrapperForDropShadow">
<div class="DropShadowHeader BlueGradientForDropShadowHeader">
<div class="DownArrow" id="scoreboardArrowId"></div>
<h4 class="WithArrowToLeft">Scoreboard</h4>
<span> <a
	href="<?php echo $urlGen->getMainScoresAndMatchesPageUrl(true); ?>"
	title="Football Score Board">See More &raquo;</a> </span></div>
<div class="WrapperForScoreTab" id="scoretabBodyId">
<div id="ScoresTabs">
<ul style="height: 31px;">
                                    <?php if ($session->email != null) { ?>
                                      <li><a href="#tab1"><span>My
	Scoreboard</span></a></li>
                                    <?php }?>  
                                      <li><a href="#tab2"><span>Top
	Scores</span></a></li>
	<li><a href="#tab3"><span>Schedule</span></a></li>
</ul>

<a class="trigger" id="customScoreBoard" href="#">Customize</a>
                                    <?php if ($session->email != null) { ?>                      
                                     <div id="editscore"
	class="ScoresEdit scoresClosed">
<p>Select up to 20 regions and countries you'd like to see in your
scoreboard. You can see all scores from around the world here.</p>
                                      <?php foreach($this->countryList as $country) {
                                                ...
                                                ?>
                                              <input type="checkbox"
	<?php echo $checked; ?> value="<?php echo $country["country_id"]; ?>"
	name="competition" id="country_<?php echo $country["country_id"]; ?>" /><label
	for="<?php echo $country["country_name"]; ?>"><?php echo $country["country_name"]; ?></label><br>
                                          <?php
                                            $checked = '';
                                          } ?>
                                          <input id="saveEditFavorites"
	class="submit" type="submit" value="Save" /> <input class="submit"
	type="button" value="Cancel" /></div>
                                <?php }?>
                               <?php if ($session->email != null) { ?>  
                               <div id="tab1">

<div class="FeaturedNewsSort" id="MyScoresDateFilter"><a href="#"
	id="todayms" class="filterSelected">Today</a> | <a
	href="javascript:void(0);" id="l3ms">Last 3 Days</a> | <a
	href="javascript:void(0);" id="l7ms">Last 7 Days</a> |</div>
...
<div id="scoreboardResult0">Loading..</div>
                              ...
                              <div id="tab2">
<div class="FeaturedNewsSort" id="ScoresDateFilter"><a href="#"
	id="today" class="filterSelected">Today</a> | <a
	href="javascript:void(0);" id="l3">Last 3 Days</a> | <a
	href="javascript:void(0);" id="l7">Last 7 Days</a> |</div>
...
<div id="tab3">
<div class="FeaturedNewsSort" id="SchedulesDateFilter"><a href="#"
	id="tomorrow" class="filterSelected">Tomorrow</a> | <a
	href="javascript:void(0);" id="n3">Next 3 Days</a> | <a
	href="javascript:void(0);" id="n7">Next 7 Days</a> |</div>
<div id="ScorecardContainer">
<div id="scoreboardResult2">Loading..</div>
</div>
