   ...
   jQuery(document).ready(function() {
	...
	jQuery("#bugtextareaId").charCounter(200);
        ...
        jQuery('#bugsendbuttonId').click(function(){
            ...
            jQuery.ajax({
    			type: 'POST',
    			//data: ({bugtext: bugText , type : 'error500' , requestedpage : requestedpage}),
...
<!-- 	/left -->
    <div class="page">
        <p class="pageerror"><img src="<?php echo Zend_Registry::get("contextPath"); ?>/public/images/500page.jpg" alt=""/></p>
        <p class="page1">The page you requested is no longer available or cannot be found. Help us correct the mistake by reporting it as a bug or double-check the URL (address) and try again it you misspelled something.</p>
        <div class="some">
                <p class="here">Here are some other useful pages</p>
                <div class="play">
                    <div class="players">
                        <ul>
                                <li><a href="<?php echo Zend_Registry::get("contextPath"); ?>" title="Home Page">Home Page</a></li>
        ...
        <div class="go">
                <p class="go1"><a href="<?php echo Zend_Registry::get("contextPath"); ?>">Go to the GoalFace Home Page</a></p>
        </div>
            <div class="need">
            <form method="get" action="<?php echo $urlGen->getSearchMainUrl(true); ?>">
                  ...
                  <div id="alertErrorMessageId" class="inlineMessageWide alertError closeDiv" style="width:346px;margin-left:10px;padding-left:28px;">
                    ...
                    <form id="reportbugid" method="post"  action="">
                      <input type="hidden" name="type" value="error500">
                      <div class="bug">
                        <p class="look">
